...
def main():
    ...
    user = GetUser()
    dbpath = '/var/home/' + user + '/.var/app/net.lutris.Lutris/data/lutris/pga.db'
    dim = GetCoverType()
    auth = GetAPIKey()
...
def GetCoverType():
    ...
    if ans == 'Banner (460x215)':
        covpath = '/var/home/' + user + '/.var/app/net.lutris.Lutris/data/lutris/banners/'
        dim = '460x215'
    else:
        covpath = '/home/' + user + '/.var/app/net.lutris.Lutris/data/lutris/coverart/'
        dim = '600x900'
    return dim
